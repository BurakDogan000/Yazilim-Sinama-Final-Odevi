...
{
    public partial class formAnaIslemYeri : MetroFramework.Forms.MetroForm
    {
        public formAnaIslemYeri()
        {
            InitializeComponent();
        }
        ...
        private void projelerim()
        {
            ...
            {
                cmbProjeler.Items.Add(item.Projeİsmi);
            }
        ...
        private void gorevleriListele()
        {
            ...
            int i = cmbProjeler.SelectedIndex;
        ...
        {
            Gorev gr = new Gorev();
            foreach (Gorev item in _projelerim[cmbProjeler.SelectedIndex].Gorev)
            {
            ...
            formGorev fg = new formGorev(gr, _projelerim[cmbProjeler.SelectedIndex]);
            fg.ShowDialog();
        }
        ...
        private void sureHesapla()
        {
            ...
            c.Parameters.AddWithValue("@p1", _projelerim[cmbProjeler.SelectedIndex].Id);
            SqlDataReader dr = c.ExecuteReader();
            while (dr.Read())
            {
            ...
            vt.bagla().Close();
            lblTahminiSure.Text = tahmin.ToString();
            lblGecenSure.Text = gecen.ToString();
        }
        ...
        {
            formProjeOlustur fpy = new formProjeOlustur();
            fpy.ShowDialog();
            projelerim();
        }
        ...
        private void cmbProjeler_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cmbProjeler.SelectedItem != null)
            {
                ...
                btnGorevDegisimiHareketi.Enabled = true;
                gorevleriListele();
            }
            sureHesapla();
        }

        private void btnGorevEkleme_Click(object sender, EventArgs e)
        {
            formGorev fg = new formGorev(_projelerim[cmbProjeler.SelectedIndex]);
            fg.ShowDialog();
            int i = cmbProjeler.SelectedIndex;
            projelerim();
            cmbProjeler.SelectedIndex = i;
        }

        private void btnGorevliEkleme_Click(object sender, EventArgs e)
        {
            formGorevli fgl = new formGorevli(_projelerim[cmbProjeler.SelectedIndex]);
            fgl.ShowDialog();
            int i = cmbProjeler.SelectedIndex;
            projelerim();
            cmbProjeler.SelectedIndex = i;
        ...
        private void btnGorevDegisimiHareketi_Click(object sender, EventArgs e)
        {
            formGorevDegisimHareketler fgh = new formGorevDegisimHareketler(_projelerim[cmbProjeler.SelectedIndex].Id);
            fgh.ShowDialog();
        }

        private void formAnaIslemYeri_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }

        private void formAnaIslemYeri_Load(object sender, EventArgs e)
        {
            lblKullaniciAdi.Text = "Hoşgeldin " + Kullanici._login.Adi + " " + Kullanici._login.Soyadi;
            projelerim();
        }
    }
}
